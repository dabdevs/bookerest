    ...
    return (
        <aside className="flex">
            <div className="flex flex-col items-start w-52 h-screen px-2 py-8 space-y-8 bg-white shadow-md">
                <a href="#" className="flex gap-2 p-2 w-full text-gray-500 focus:outline-nones transition-colors duration-200 rounded-lg hover:bg-gray-100">
                ...
                <a href="#" className="flex gap-2 p-2 w-full text-blue-500 transition-colors duration-200 bg-blue-100 rounded-lg">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
